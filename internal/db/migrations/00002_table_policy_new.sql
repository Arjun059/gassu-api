...
CREATE TABLE role_policy_assignments (
    ...
    CONSTRAINT uq_role_permission_policy
        UNIQUE (role_id, permission_id, policy_id),
...
ON role_policy_assignments(role_id, permission_id);
...
CREATE TABLE user_policy_assignments (
    ...
    CONSTRAINT uq_user_permission_policy
        UNIQUE (user_id, permission_id, policy_id),
...
ON user_policy_assignments(user_id, permission_id);
